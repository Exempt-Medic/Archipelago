    ...
    def reduce_req_within_region(self, panel_hex: str) -> FrozenSet[FrozenSet[str]]:
        ...
        for option in these_panels:
            ...
            for option_entity in option:
                ...
                elif option_entity in {"7 Lasers", "11 Lasers", "7 Lasers + Redirect", "11 Lasers + Redirect", "PP2 Weirdness", "Theater to Tunnels", "NRS", "FOV"} or option_entity.startswith("Foreknowledge") or option_entity.startswith("Snipes"):
                    new_items = frozenset({frozenset([option_entity])})
                else:
