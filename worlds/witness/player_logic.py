...
class WitnessPlayerLogic:
    ...
    def reduce_req_within_region(self, panel_hex: str, allow_victory: bool) -> FrozenSet[FrozenSet[str]]:
        ...
        for option in these_panels:
            ...
            for option_entity in option:
                ...
                if option_entity in {"7 Lasers", "11 Lasers", "7 Lasers + Redirect", "11 Lasers + Redirect", "PP2 Weirdness", "Theater to Tunnels", "NRS", "FOV"} or option_entity.startswith("Foreknowledge") or option_entity.startswith("Snipes"):
    ...
    def determine_unrequired_entities(self, world: "WitnessWorld"):
        ...
        is_item_required_dict = {
            ...
            "0x3865F": symbols_shuffled or not remote_doors_no_panels or eps_shuffled, # Quarry Boathouse Second Barrier Door
            ...
            "0x09FA0": foreknowledge <= 2, # Desert Surface Control 3
            "0x09F86": foreknowledge <= 2, # Desert Surface Control 8
